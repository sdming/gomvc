...
const (
    ...
    MesServerInternalErr = "server internal error" // server internal error
)
...
var (
    ...
    EnableDebug   bool        = true  //enable debug or not
...
func (s *HttpServer) InternalError(ctx *HttpContext) {
    http.Error(ctx.Resonse, MesServerInternalErr, http.StatusInternalServerError)
}
